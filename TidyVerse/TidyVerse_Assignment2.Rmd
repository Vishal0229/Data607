...
### <u>Extended by Samriti and Vishal</u>
...
Example
we wanted to convert the water temperature from Celsius to Farenheit in water.quality.tbl data frame

```{r transmute, echo=TRUE, warning=FALSE, message=FALSE, comment=NA}
...
Description
The _if() variants apply a predicate function (a function that returns TRUE or FALSE) to determine the relevant subset of columns. Here we apply mean() to the numeric columns:
