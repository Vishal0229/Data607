...
Then extending the same and plotting the linear model for each subgroup(i.e. Region)
, setting  the method=lm inside the geom_smooth function.            
 
 ```{r warning=FALSE}
 
 
 ggplot(happinessDF,aes(x=Family,y=`Economy (GDP per Capita)`,col=Region))+
  geom_point() 
