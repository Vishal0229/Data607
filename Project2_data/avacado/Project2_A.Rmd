...
##Solution :-
We are using below libraries in our ques to resolve the above problem.:-
```{r include=FALSE}
library(readxl)
library(dplyr)
library(kableExtra)
...
##Summary :-
 Using the graph we can clearly see that California region has the highest total sales of Avacado, followed by North East region anmd West region has the least consumption on avacado.
